...
import { UploadUrlRequestSchema, parseBody } from '../../utils/validators';
...
export const handler = async (
  ...
  try {
    ...
    const input = parseBody(UploadUrlRequestSchema, event.body);
    const result = await mediaService.getUploadUrl(team, input);
